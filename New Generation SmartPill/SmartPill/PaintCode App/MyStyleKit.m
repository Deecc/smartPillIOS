...
+ (void)drawAddHelpText;
{
    ...
    //// Text Drawing
    CGRect textRect = CGRectMake(57, 197, 208, 77);
    ...
    UIBezierPath* image10548Lowest2Path = [UIBezierPath bezierPathWithRect: CGRectMake(265, 197, 50, 50)];
    CGContextSaveGState(context);
    [image10548Lowest2Path addClip];
    CGContextScaleCTM(context, 1.0, -1.0);
    CGContextDrawTiledImage(context, CGRectMake(265, -197, arrow.size.width, arrow.size.height), arrow.CGImage);
